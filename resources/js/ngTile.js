    ...
    'usedColors', []
        ...
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                scope.onClick = function (link, target) {
                    if (link)
                        window.open(link, target ? target : '');
                };
            },
            template:
            '<div class="{{link != undefined ? \'tileLink\' : \'\'}}" ng-click="onClick(link, target)">' +
        ...
        return {
            ...
            template:
            '<div ng-repeat="i in tileParams.data">' +
            '<div class="{{tileParams.colSize}} tileCol">' +
            '<div class="{{tileParams.tileType}} {{ i.link != undefined ? \'tileLink\' : \'\'}}" ng-style="{\'background-color\': setRandomColors[$index]}" ng-click="onClick(i.link, i.target)">' +
